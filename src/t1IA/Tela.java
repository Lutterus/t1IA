...
public class Tela extends JFrame {
	...
	public Tela(Heuristic heu) {
		...
		ButtonAlgoritmoA.addActionListener(new ActionListener() {
		...
		ButtonAlgoritmoGnetico.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				.addGroup(gl_contentPane.createParallelGroup(Alignment.TRAILING)
						...
						.addGroup(gl_contentPane.createSequentialGroup().addGroup(gl_contentPane
								...
								.addGroup(gl_contentPane.createSequentialGroup()
										...
										.addPreferredGap(ComponentPlacement.UNRELATED).addComponent(panel_4,
												GroupLayout.PREFERRED_SIZE, 18, GroupLayout.PREFERRED_SIZE))
								.addGroup(gl_contentPane.createSequentialGroup()
										.addGroup(gl_contentPane.createParallelGroup(Alignment.TRAILING)
												.addComponent(ButtonAlgoritmoGnetico, Alignment.LEADING,
														GroupLayout.DEFAULT_SIZE, 209, Short.MAX_VALUE)
												.addComponent(lblAlgoritmoA, Alignment.LEADING,
														GroupLayout.DEFAULT_SIZE, 209, Short.MAX_VALUE))
										.addGap(29)))
								...
								.addGroup(gl_contentPane.createParallelGroup(Alignment.TRAILING)
										...
										.addComponent(lblAlgoritmoGentico, Alignment.LEADING, GroupLayout.DEFAULT_SIZE,
												220, Short.MAX_VALUE))))
				.addContainerGap()));
		gl_contentPane
				.setVerticalGroup(
						gl_contentPane.createParallelGroup(Alignment.TRAILING)
								.addGroup(gl_contentPane.createSequentialGroup()
										.addGroup(gl_contentPane.createParallelGroup(Alignment.BASELINE)
												.addComponent(lblAlgoritmoGentico, GroupLayout.PREFERRED_SIZE, 26,
														GroupLayout.PREFERRED_SIZE)
												.addComponent(lblAlgoritmoA))
										.addPreferredGap(ComponentPlacement.RELATED)
										.addGroup(gl_contentPane.createParallelGroup(Alignment.LEADING)
												.addComponent(ButtonAlgoritmoA).addComponent(ButtonAlgoritmoGnetico,
	...
	private class DrawEstrela extends JPanel {
	...
	private class DrawHeuristica extends JPanel {
